...
@REM copy current compiler configuration to test directory
@copy /y %BAUHAUS_CONFIG%\compiler_config.json %~dp0\ti-cgt-arm_20.2.6.lts\test\ti_cgt_arm\cafeCC_config\compiler_config.json
@copy /y %BAUHAUS_CONFIG%\axivion_preinc.h %~dp0\ti-cgt-arm_20.2.6.lts\test\ti_cgt_arm\cafeCC_config\axivion_preinc.h
...
%TEST_RUNNER% %* --language C11 ti-cgt-arm_20.2.6.lts/test/ti_cgt_arm/**/*.c ti-cgt-arm_20.2.6.lts/test/ti_cgt_arm/**/*.cpp

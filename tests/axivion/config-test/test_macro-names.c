...
#define MACRO_MISSES_PREFIX  /* must fail */
#define macro_has_bad_casing /* must fail */

// test: TESTCASE.add_expected_stdout("test_macro-names.c:10:9: error: The macro name is not 'ALL_CAPS'. [MACRO_MISSES_PREFIX] (Rule CodingStyle-Naming.Macro)")

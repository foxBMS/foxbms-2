...
@gcc %~dp0crc-15_0xc599.c -o%~dp0crc-15_0xc599.exe
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)
@gcc %~dp0crc-10_0x48f.c -o%~dp0crc-10_0x48f.exe
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)
@ECHO Running '%~dp0crc-15_0xc599'
@%~dp0crc-15_0xc599.exe
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)
@ECHO.
@ECHO Running '%~dp0crc-10_0x48f'
@%~dp0crc-10_0x48f.exe
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1

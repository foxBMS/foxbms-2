...
.. |local_bms_slave_version| replace:: ``2.1.5``
.. |local_bms_slave_identifier_short| replace:: |ltc-ltc6811-1|\ -based 12-Cell |bms-slave|
.. |local_bms_slave_identifier_full| replace:: |local_bms_slave_identifier_short| |local_slave_version_start| to |local_bms_slave_version|

.. _LTC_LTC6811_1_BASED_12_CELL_BMS_SLAVE_V2_1_2_TO_V2_1_5:
...
.. note::
   ...
   :numref:`CHANGELOG_FOR_THE_LTC_LTC6811_1_BASED_12_CELL_BMS_SLAVE_V2_1_2`.
...
.. important::
   ...
   versions |local_slave_version_start| to |local_bms_slave_version|.
...
.. csv-table:: Electrical Ratings
   :name: 6811-1_slave_12cell_v2.1.2_electrical_ratings
   :header-rows: 1
   :delim: ;
   :file: ./12-ltc-ltc6811-1-v2.1.2/12-ltc-ltc6811-1-v2.1.2_electrical-ratings.csv
...
.. csv-table:: Mechanical Dimensions
   :name: 6811-1_slave_12cell_v2.1.2_mechanical_dimensions
   :header-rows: 1
   :delim: ;
   :file: ./12-ltc-ltc6811-1-v2.1.2/12-ltc-ltc6811-1-v2.1.2_mechanical-dimensions.csv
...
:numref:`block_diagram_6811-1_slave_12cell_v2.1.2`.

.. _block_diagram_6811-1_slave_12cell_v2.1.2:
.. drawio-figure:: ./12-ltc-ltc6811-1-v2.1.2/12-ltc-ltc6811-1-v2.1.2.drawio
   :width: 100 %
   :format: svg
   :align: center
...
are controlled by the primary |ltc-ltc6811-1| monitoring IC.
The secondary |ltc-ltc6811-1| does not support balancing.
...
connected to the |ltc-ltc6811-1|.
This allows the |bms-master| to check whether any balancing action is currently
taking place.
The feedback signal is connected to the GPIO3 of the |ltc-ltc6811-1|.
...
.. drawio-figure:: ./../../img/connectors_molex_micro_fit_16pins.drawio
   :format: svg
   :width: 300px
...
The analog multiplexer can be controlled via |I2C| by the |ltc-ltc6811-1|
(7-bit address: 0x4C).
...
sensor is used.
This temperature sensor can be read by the |ltc-ltc6811-1| via the |I2C| bus
(7-bit address: 0x48).
...
The analog multiplexers can be controlled via |I2C| by the |ltc-ltc6811-1|
...
resistors (see paragraph :ref:`hardware_slave_daisy_current_12cell_v2.1.2`).
...
The internal software timer of the |ltc-ltc6811-1| can be enabled/disabled by a
dedicated external pin (SWTEN, pin 36 of the |ltc-ltc6811-1|).
...
.. _hardware_slave_daisy_current_12cell_v2.1.2:
...
over 50m.
More information can be found in the |ltc-ltc6811-1| datasheet.

Status LED
""""""""""

The status LEDs LD201 and LD301 show the current mode of each, the primary and
secondary |ltc-ltc6811-1|.
...
The internal GPIO lines of the primary or secondary |ltc-ltc6811-1| can be

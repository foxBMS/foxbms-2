...
.. _LTC_LTC6813_1_BASED_18_CELL_SLAVE___V1_1_3__:

LTC LTC6813-1-based 18-Cell Slave ``v1.1.3``
============================================

.. note::

   The changelog for this release is found at
   :ref:`CHANGELOG_FOR_SLAVE_LTC_LTC6813_1_V1_1_3`.

.. |local_slave_version|  replace:: ``1.1.3``
...
.. important::
   ...
   The following description only applies for the |ltc-ltc6813-1|\ -based 18

...
.. note::
   ...
   As mentioned in :ref:`FOX_CLI_BASICS` it is recommended to use one of the
   shell scripts to interact with the repository, as these activate the correct
   build environment and prepare the ``PATH`` variable before starting the
   build process.

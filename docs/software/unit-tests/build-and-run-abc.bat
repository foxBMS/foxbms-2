...
@pushd %~dp0
@ECHO Build and link 'abc'-driver

@gcc -DUNITY_UNIT_TEST -c abc.c -o abc.o
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)

@gcc -DUNITY_UNIT_TEST -c run_abc.c -o run_abc.o
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)

@gcc -o run_abc.exe abc.o run_abc.o
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)
...
@ECHO Build and link test file for 'abc'-driver

@gcc -DUNITY_UNIT_TEST -c test_abc.c -o test_abc.o
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)

@gcc -o test_abc.exe test_abc.o abc.o
@IF %ERRORLEVEL% neq 0 (
    @POPD
    @EXIT /b 1
)
